...
def _usage(out=None):
    ...
    text = (
        ...
        f"  {p} -x [--disam|--decompile] <input_pck|input_dir> [output_dir] [--angou VALUE]\n"
        ...
        "    --decompile    Dump .dat disassembly and reconstructed decompiled/*.ss scripts\n"
        "    --gei          Restore Gameexe.ini from Gameexe.dat\n"
        "    output_dir     Defaults to the input file directory or the input directory itself\n"
        "\n"
        "Analyze mode:\n"
        f"  {p} -a [--disam|--decompile] <input_file.(pck|dat)> [--angou VALUE]\n"
        ...
        "    --decompile    Write <scene>.dat.txt plus reconstructed decompiled/*.ss scripts\n"
